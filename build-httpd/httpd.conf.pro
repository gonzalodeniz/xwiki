...
# Comento mod_auth_cas si no lo necesito
...
<VirtualHost *:443>
    ...
    RewriteRule ^/aplicaciones/ciberwiki$ /aplicaciones/ciberwiki/ [R]
    
    # Sustituye en el cuerpo html las direcciones %2F por la barra
    SetOutputFilter SUBSTITUTE
    Substitute "s|aplicaciones%2Fciberwiki|aplicaciones/ciberwiki|i"
    ...
    # Proxy Reverse
    ProxyPass /aplicaciones/ciberwiki/ http://xwiki:8080/aplicaciones/ciberwiki/ nocanon
    ProxyPassReverse /aplicaciones/ciberwiki/ http://xwiki:8080/aplicaciones/ciberwiki/
   
    # Modifications de headers attribute Secure
    Header edit Set-Cookie ^(.*)$ $1;Secure;HttpOnly

   #Desactivar protocolos de cifrado inseguro
