...
<hibernate-configuration>
  <session-factory>
    ...
    -->
    <property name="connection.url">jdbc:postgresql://cuestion-db01p.gobiernodecanarias.net:5432/xwiki?</property>
    <property name="connection.username">cuestion-bd</property>
    <property name="connection.password">Cibercentro24.</property>
